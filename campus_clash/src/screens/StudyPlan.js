...
function StudyPlan(){
    ...
    const studyPlans =[ {
        ...
        tasks: [{
            ...
            description: "Exam 2 is worth 15% of your grade. Getting above a 80% can bring your F to a D"
        },
        {
            header: "Turn in HW 03",
            description: "Failing to turn in HW 01 will cause your grade to drop by 3% to a 47% F"
        },
        {
    ...
    },
    {
        ...
        tasks: [
        {
            ...
            description: "Getting 100% on assignment 2 will increase your grade by 10% to a 73% D"
        }]
    },
    {
        title: "CMPSC 475",
        ...
        tasks: [
        {
            ...
            description: "Missing Assignmnet 3 will drop your grade by 10% to a 85% B"
        }]
    }
    ]
        ...
        <Container className="py-3 mb-5">
            ...
            {studyPlans.map((e, k) => (
                <InfoBox>
                    ...
                    {e.tasks.map((task, j) => (
                        <StudyTaskCard title={task.header} description={task.description}></StudyTaskCard>
                    ))}
